<div id="content">
        <div class="left">
            <div id="post">
                ...
                <div class="p_desc">
                    ...
                    <div class="p_comm">
                        <p class="time">Posted on Feb 14, 2017&nbsp; &nbsp; &nbsp;|</p>
            ...
            <div id="reply">
                ...
                <div id="comm_form">
                    <?php if(!empty($this->session->userdata('username'))){
                            echo form_open_multipart('Cardio/insert_comm', array('method'=>'post', 'id'=>'form'));
    ...
    <div class="right">
            ...
            <div id="motivation">
              ...
              <div id="mot_pic">
                  <blockquote>
                      <p>I never run hills. My quads are already big enough. I don't run to build muscle; I do it for cardio.</p>
                  </blockquote>
                  <blockquote>
                      <p>If you do cardio one day and the next day you can do weights, do it that way.</p>
                  </blockquote>
                  <blockquote>
                      <p>The gym that I have in my building is amazing. I love to do cardio there.</p>
                  </blockquote>
              </div>
            </div>
            </div>
